...
public:
    /*
        ...
        - Get the current tail(node just next to the group to be reversed)
        ...
        - Reverse the current group manually while updating tail to the reversed head and return the tail
    */
